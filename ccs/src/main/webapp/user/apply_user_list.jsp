...
<center>
      <TABLE width="778" border=0 cellPadding=0 cellSpacing=0 borderColor=#ffffff bgColor=#dee7ff style="FONT-SIZE: 10pt">
        <TBODY>
          ...
          bgColor=#dee7ff><FONT color=#f7f7f7>用户申请单列表<font color="#FFFFFF">&nbsp;</font></FONT> </TD>
      ...
      <TABLE width="778" border=0 align=center cellPadding=0 cellSpacing=0 borderColor=#ffffff style="FONT-SIZE: 10pt">
        <TBODY>
          ...
          <TR>
            ...
            */
            %>
            <a href="#" onclick="openWin('user.do?method=addInput','addparty',600,200);">添加用户申请单</a>
            </TD>
          </TR>
          <TR>
      ...
      <table width="778" border="0" cellPadding="0" cellSpacing="1" bgcolor="#6386d6">
	      ...
	      <tr bgcolor="#EFF3F7" class="TableBody1">
		      <td width="20%" height="37" align="center"><b>申请日期</b></td>
		      <td width="20%" height="37" align="center"><B>申请等级</B></td>
		      <td width="20%" height="37" align="center"><b>申请状态</b></td>
		      <td width="20%" height="37" align="center"><b>用户姓名</b></td>
              <td width="20%" height="37" align="center"><b>相关操作</b></td>
          </tr>
          <!-- 列表数据栏 -->
	      ...
	      <tr bgcolor="#EFF3F7" class="TableBody1" onmouseover="this.bgColor = '#DEE7FF';" onmouseout="this.bgColor='#EFF3F7';">
	          ...
	          <c:if test="${au.applyState eq '正在申请' }">
	          <a href="user.do?method=auditUser&aid=${au.id }&pass=true">通过</a>
	          <a href="user.do?method=auditUser&aid=${au.id }&pass=false">不通过</a>
	          </c:if>
	          </td>
        </tr>
        </c:forEach>
